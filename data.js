...
export const foodGuide = [
    ...
    { name: 'AFURI – ראמן יוזו',            city: 'tokyo', area: 'שינג׳וקו / הרג׳וקו',  category: 'ramen',    desc: 'ראמן יוזו שיו ייחודי – ~¥1,300. אופציה במקום שוגון בורגר ביום 6', day: 6  },
    ...
    { name: 'Rare Tendon Ginza',             city: 'tokyo', area: 'גינזה',               category: 'street',   desc: 'קערת טמפורה (טנדון) מפורסמת – חוויה יפנית ייחודית בגינזה. אופציה לצהריים', day: 5  },
    // ── YAKINIKU ──
...
export const days = [
    ...
    },
    {
        ...
        activities: [
            ...
            { name: "Henry's Burger / שוגון בורגר – צהריים", time: '14:00', desc: "🍔 Henry's Burger – בורגר ואגיו מפורסם בהרג׳וקו, תור קצר שווה את זה | 🍔 שוגון בורגר – ואגיו 100% ליד ראש הגודזילה בשינג׳וקו. בחרי לפי מיקום!", lat: 35.6715, lng: 139.7035, type: 'restaurant' },
            { name: 'Toy Sapiens – חנות מארוול', time: '15:30', desc: 'חנות פיגורינות ואספנות של חובבי מארוול, DC ועוד – שיבויה. מקום חובה לאוהבי סופרהירואים!', lat: 35.6614, lng: 139.6984, type: 'attraction' },
    ...
    },
    {
        ...
        activities: [
            ...
            { name: 'הגעה לאקיהברה – Electric Town', time: '12:00', desc: 'JR Yamanote Line → תחנת Akihabara, יציאת Electric Town Exit. מגיעות לב האזור', lat: 35.7023, lng: 139.7745, type: 'attraction' },
            { name: 'Radio Kaikan', time: '12:15', desc: 'דקה מהתחנה! קומה 2: A-STOP עם פריטים ייחודיים. קומה 4: AmiAmi. קומות עליונות: קלפי Pokémon ו-Yu-Gi-Oh, מודלים וצעצועים', lat: 35.7018, lng: 139.7742, type: 'attraction' },
            { name: 'Gokatsu Motomura – טונקאטסו', time: '13:30', desc: 'מסעדת טונקאטסו פופולרית, 6-8 דק׳ הליכה. יש תור אבל קצר יחסית – להגיע בפתיחה לקצר המתנה', lat: 35.7005, lng: 139.7730, type: 'restaurant' },
            { name: 'Super Potato – גיימינג רטרו', time: '15:00', desc: '3 קומות של נוסטלגיה: משחקים קלאסיים, קונסולות נדירות וקומת ארקייד עליונה. 7 דק׳ הליכה', lat: 35.7012, lng: 139.7738, type: 'attraction' },
            { name: 'מכונות גאצ׳ה + חנויות משומשות', time: '16:00', desc: 'להגביל תקציב! כדאי לבדוק קודם בחנויות המשומשות – לעיתים זול בהרבה ממה שבמדף', lat: 35.7023, lng: 139.7745, type: 'attraction' },
            { name: 'Hirosa Entertainment Yard – ארקייד', time: '17:00', desc: 'ארקייד מודרני עם שילוב של משחקים חדשים וישנים. תשלום ב-Suica. עובד יסייע אם נתקעתן במכונת תפיסה', lat: 35.7015, lng: 139.7748, type: 'attraction' },
            { name: 'מקדש Kanda Myojin – סיום היום', time: '18:30', desc: '10-12 דק׳ הליכה מהאזור. שקט ומרגיע – האווירה בין-ערביים מדהימה. מפורסם בקמע "הגנה על אלקטרוניקה" 😄', lat: 35.7021, lng: 139.7659, type: 'attraction' },
        ]
    },
    {
        ...
        activities: [
            ...
            { name: 'Rare Tendon / סושי קייטן גינזה אונודרה – צהריים', time: '13:00', desc: '🍤 Rare Tendon – קערת טמפורה מפורסמת בגינזה, חווית אוכל יפנית ייחודית | 🍣 גינזה אונודרה – סושי קייטן מבית השף אונודרה. שתיהן בגינזה – בחרי לפי מצב הרוח!', lat: 35.6717, lng: 139.7660, type: 'restaurant' },
            { name: 'גינזה – יוניקלו + MUJI + LOFT', time: '15:00', desc: 'יוניקלו הגדול בעולם (12 קומות) | MUJI גינזה – הסניף הדגל, 6 קומות של עיצוב יפני | LOFT – כלי בית, נייחות ומתנות יפניות. כולם ברחוב גינזה', lat: 35.6715, lng: 139.7636, type: 'attraction' },
    ...
    },
    {
        ...
        activities: [
            ...
            { name: 'שוגון בורגר / AFURI ראמן – בחרי אחת', time: '13:30', desc: '🍔 שוגון בורגר – ואגיו 100% ממש ליד ראש הגודזילה | 🍜 AFURI שינג׳וקו – ראמן יוזו שיו ייחודי (~¥1,300). שתיהן באותו איזור, בחרי לפי מצב הרוח!', lat: 35.6952, lng: 139.7038, type: 'restaurant' },
            ...
            { name: 'דון קיחוטה שינג׳וקו', time: '17:00', desc: 'הסניף הכי גדול של דון קי בטוקיו – 8 קומות של קוסמטיקה, חטיפים, ביגוד וכל מה שדמיינתן. פתוח עד 5 בבוקר!', lat: 35.6951, lng: 139.7009, type: 'attraction' },
